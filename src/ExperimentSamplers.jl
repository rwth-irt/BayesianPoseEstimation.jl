...
function mh_sampler(cpu_rng, params, experiment, posterior)
    ...
    t_ind_proposal = independent_proposal((; t=t_ind), posterior)
    r_ind_proposal = independent_proposal((; r=r_ind), posterior)
    ...
    t_sym_proposal = symmetric_proposal((; t=t_sym), posterior)
    r_sym_proposal = symmetric_proposal((; r=r_sym), posterior)
...
function smc_mh(cpu_rng, params, posterior)
    ...
    # o_sym_proposal = symmetric_proposal((; o=o_sym), posterior)
