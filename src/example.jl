...
mean(y_.y)
mm = MixtureMeasure((Normal(), Exponential()), [0.1, 1.0 - 0.1])
bm = BinaryMixture(Normal(), Exponential(), 1, 9)
logdensity(mm, 0.1)
logdensity(bm, 0.1)
histogram([rand(mm) for _ in 1:10000])
histogram([rand(bm) for _ in 1:10000])
