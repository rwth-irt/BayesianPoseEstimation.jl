...
#TODO function run_inference(parameters::Parameters, render_context, obs; kwargs...)
# Device
...
chain = sample(rng, posterior, ind_sym, 10_000; discard_initial=0_000, thinning=1);
# TODO function, kwargs...)
