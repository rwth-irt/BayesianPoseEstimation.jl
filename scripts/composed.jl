...
t_symmetric = SymmetricProposal(IndependentModel((; t=t_proposal))) |> render_model
...
ind_sym_sampler = ComposedSampler([1, 2, 3, 4, 5, 6, 4, 5, 6, 4, 5, 6], t_ind_mh, r_ind_mh, o_ind_mh, t_sym_mh, r_sym_mh, o_sym_mh)
ind_t_sym_sampler = ComposedSampler(t_sym_mh, r_ind_mh, r_sym_mh)
sym_sampler = ComposedSampler(t_sym_mh, r_sym_mh)
...
# PosteriorModel
# normalized_posterior seems way better
...
chain = sample(rng, conditioned_posterior, ind_sym_sampler, 15_000; discard_initial=10_000, thinning=2);
